...
class PaymentNotificationParserTest {
    ...
    @Test
    fun parse_bankOtherPartyAccountNameLabel_extractsMerchant() {
        val result = parser.parse(
            PaymentNotificationInput(
                packageName = "com.example.bank",
                title = "交易提醒",
                text = "尾号1234支出人民币16.20元，对方户名：地铁",
                postedAt = 100_000L,
            ),
        )
    ...
    @Test
    fun parse_transactionWithTrailingBalance_usesTransactionAmount() {
        val result = parser.parse(
            PaymentNotificationInput(
                packageName = "com.example.bank",
                title = "交易提醒",
    ...
    @Test
    fun parse_leadingFullWidthBalance_usesTransactionAmount() {
        val result = parser.parse(
            PaymentNotificationInput(
                packageName = "com.example.bank",
                title = "交易提醒",
                text = "余额人民币１，０００．００元，支出人民币16.20元，商户：地铁",
                postedAt = 100_000L,
            ),
        )
